...
import { Sellermyproductpage } from "./Sellermyproductpage.tsx";
...
export const SellerDashboardPage = () => {
  ...
  const [recentProducts, setRecentProducts] = useState<Array<{ _id: string; name: string; status: "pending" | "approved" | "rejected"; price: number; createdAt: string }>>([]);
  ...
  const statusStyle = (status: "pending" | "approved" | "rejected") => {
    if (status === "approved") {
